...
# Zip project
zip $ARCHIVE_NAME -r bot_1.js bot_2.js bot_3.js bot_3_2.js bot_4.js index_timetable.js patriot.js oracle_new_bot.js teddy_bot.js translate.js vihr_bot.js draw_bot.js
